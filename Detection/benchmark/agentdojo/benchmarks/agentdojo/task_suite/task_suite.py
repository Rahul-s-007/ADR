...
class TaskSuite(Generic[Env]):
    ...
    def log_graph_output(self, first_run_output: list[dict[str, any]], second_run_output=None):
        ...
        elif "nemo_warnings" in first_run_output: # NeMo Guardrails
            logger.set_contextarg("isolate_gpt_warnings", first_run_output["nemo_warnings"])
        ...
        if second_run_output is not None:
            ...
            elif "nemo_warnings" in second_run_output: # NeMo Guardrails
                logger.set_contextarg("second_run_isolate_gpt_warnings", second_run_output["nemo_warnings"])
