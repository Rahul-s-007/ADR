...
from function.calendar_toolkit import add_event_to_calendar
from function.calendar_toolkit import get_events_from_calendar
from function.calendar_toolkit import search_event
from function.calendar_toolkit import remove_event_from_calendar
from function.calendar_toolkit import get_today_date
...
events = []
database_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'environment/calendar.json'))
